...
const benefits = [
    {
        ...
        color: 'bg-teal text-white shadow-lg shadow-teal/20',
        delay: 0,
    },
    {
        icon: TrendingUp,
        ...
        color: 'bg-gold text-navy shadow-lg shadow-gold/20',
        delay: 0.1,
    },
    {
        icon: Leaf,
        ...
        color: 'bg-steel text-white shadow-lg shadow-steel/20',
        delay: 0.2,
    },
    {
        icon: MapPin,
        ...
        color: 'bg-navy text-white shadow-lg shadow-navy/20',
        delay: 0.3,
    },
];
