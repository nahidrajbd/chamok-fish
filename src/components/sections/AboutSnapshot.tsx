            ...
            <div className="container-custom">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="aspect-[4/3] rounded-[12px] overflow-hidden bg-gradient-to-br from-navy to-teal flex items-center justify-center">
                            <div className="text-center">
                                <Factory className="w-20 h-20 text-white/30 mx-auto mb-4" />
                                <p className="text-white/50 text-sm font-[family-name:var(--font-bengali)]">
                                    ইনাম ফিড মিল
                                </p>
                    ...
                    >
                        ...
                        <p className="text-bodyGray leading-relaxed font-[family-name:var(--font-bengali)]">
                            ...
                            রাজশাহীর চিনি পট্টি থেকে পরিচালিত এই প্রতিষ্ঠানটি আজ গুণগত
                            মান ও বিশ্বস্ততার প্রতীক।
                        </p>

                        <p className="text-bodyGray leading-relaxed font-[family-name:var(--font-bengali)]">
                            মো. খায়রুল বাশার-এর সুদক্ষ নেতৃত্বে পুঠিয়ার ধোপাপাড়ায় অবস্থিত
                            আমাদের অত্যাধুনিক কারখানা ইনাম ফিড মিলে প্রতিটি পণ্য অত্যন্ত
                            যত্নসহকারে উৎপাদিত হয়।
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div
                                    key={item.label}
                                    className="bg-mist/50 rounded-xl p-4 border border-border/40"
                                >
                                    <p className="text-teal text-xs font-medium mb-1 font-[family-name:var(--font-bengali)]">
                                        {item.label}
                                    </p>
                                    <p className="text-navy text-sm font-semibold font-[family-name:var(--font-bengali)]">
                                        {item.value}
                                    </p>
                                </div>
                            ))}
                        ...
                        <Link
                            href="/about"
                            className="btn-teal inline-flex text-sm font-[family-name:var(--font-bengali)]"
                        >
                            আরও জানুন
