    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="চমক ফিশ ফিডের রাজশাহী বিভাগের ডিলার তালিকা। আপনার কাছের ডিলার খুঁজুন অথবা নতুন ডিলার হওয়ার আবেদন করুন।" />
            ...
            <section className="bg-navy py-16">
                <div className="container-custom text-center">
                    <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-5">
                        ...
                        <span className="text-white/80 text-sm font-[family-name:var(--font-bengali)]">আমাদের ডিলার</span>
                    </div>
                    <h1 className="text-white font-bold mb-4 font-[family-name:var(--font-bengali)]">ডিলার নেটওয়ার্ক</h1>
                    <p className="text-white/65 max-w-2xl mx-auto font-[family-name:var(--font-bengali)]">
                        রাজশাহী বিভাগের বিভিন্ন উপজেলায় আমাদের বিশ্বস্ত ডিলাররা সর্বদা সেবা প্রদানের জন্য প্রস্তুত।
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding bg-pageBg">
                <div className="container-custom">
                    <h2 className="text-navy mb-2 font-[family-name:var(--font-bengali)]">আমাদের ডিলার তালিকা</h2>
                    <p className="text-bodyGray text-sm mb-8 font-[family-name:var(--font-bengali)]">আপনার কাছের ডিলারের সাথে যোগাযোগ করুন</p>
            ...
            <section className="py-12 bg-panelBg">
                <div className="container-custom">
                    <h2 className="text-navy mb-6 text-center font-[family-name:var(--font-bengali)]">আমাদের অফিসের অবস্থান</h2>
            ...
            <section className="section-padding bg-pageBg">
                <div className="container-custom max-w-2xl">
                    <div className="text-center mb-10">
                        <span className="inline-block bg-gold/10 text-gold text-sm font-medium px-4 py-1.5 rounded-full mb-4 font-[family-name:var(--font-bengali)]">ডিলার হওয়ার সুযোগ</span>
                        <h2 className="text-navy mb-4 font-[family-name:var(--font-bengali)]">ডিলার হওয়ার আবেদন করুন</h2>
                        <p className="text-bodyGray leading-relaxed font-[family-name:var(--font-bengali)]">
                            আপনার এলাকায় চমক ফিশ ফিডের ডিলার হোন। লাভজনক ব্যবসার সুযোগ নিন।
                        </p>
                    </div>
