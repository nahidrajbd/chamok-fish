...
export default function ContactPage() {
    return (
        <>
            <Helmet>
                <title>যোগাযোগ করুন — চমক ফিশ ফিড</title>
                <meta name="description" content="চমক ফিশ ফিডের সাথে যোগাযোগ করুন। ফোন, WhatsApp বা ফর্মের মাধ্যমে পণ্যের তথ্য, অর্ডার ও ডিলার সম্পর্কে জানুন।" />
            ...
            <section className="bg-navy py-16">
                <div className="container-custom text-center">
                    <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-5">
                        ...
                        <span className="text-white/80 text-sm font-[family-name:var(--font-bengali)]">যোগাযোগ</span>
                    </div>
                    <h1 className="text-white font-bold mb-4 font-[family-name:var(--font-bengali)]">আমাদের সাথে যোগাযোগ করুন</h1>
                    <p className="text-white/65 max-w-xl mx-auto font-[family-name:var(--font-bengali)]">
                        পণ্য সম্পর্কে জানতে, অর্ডার করতে বা যেকোনো প্রশ্নের জন্য আমাদের সাথে যোগাযোগ করুন।
                    </p>
                </div>
            </section>
                ...
                <div className="container-custom">
                    <div className="grid lg:grid-cols-5 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            <div className="flex items-start gap-4 bg-cardBg rounded-card p-5 border border-border/40">
                                <div className="w-10 h-10 bg-gold/10 rounded-xl flex items-center justify-center shrink-0">
                                    <MapPin className="w-5 h-5 text-gold" />
                                </div>
                                <div>
                                    <p className="text-bodyGray text-xs mb-0.5 font-[family-name:var(--font-bengali)]">কারখানা</p>
                                    <p className="text-navy font-semibold text-sm font-[family-name:var(--font-bengali)]">{siteConfig.factoryAddress}</p>
                                </div>
                            </div>

                            <div className="bg-mist/50 rounded-card p-5 border border-border/30">
                                <div className="flex items-center gap-3 mb-3">
                                    <Clock className="w-5 h-5 text-teal" />
                                    <p className="text-navy font-semibold text-sm font-[family-name:var(--font-bengali)]">কার্যালয়ের সময়</p>
                                </div>
